    ...
    return (
        <main className="min-h-screen bg-white overflow-x-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-3xl border-2 border-blue-200 shadow-lg my-12">
                            <h3 className="text-2xl font-black text-gray-900 mb-4 sm:mb-6 flex items-center gap-3">
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-50">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-4 sm:mb-6">Our Lease Return Services</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Bumper scuffs, cracks, and paint chips — among the most common lease return damage items — repaired and colour-matched within a day.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Scratches and paint marks on lease vehicles repaired with precision colour matching — essential for passing a BVRLA inspection.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Panel dents and door dings on lease vehicles removed using paintless and traditional techniques ahead of your handover inspection.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Accident damage on lease vehicles repaired to pre-accident condition before the scheduled return date — avoiding assessor charges.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Complete vehicle resprays for lease cars requiring full paint restoration — available where extensive surface damage has occurred.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Fleet and lease preparation services for motor traders, dealerships, and fleet operators managing multiple vehicle returns.</p>

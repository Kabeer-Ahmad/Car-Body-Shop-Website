                ...
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                            ...
                            <p className="text-gray-600 leading-relaxed">Most repairs completed within 2-4 working days. We understand you need your vehicle back quickly.</p>
                        </div>
                        <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                            ...
                            <p className="text-gray-600 leading-relaxed">Free itemised quotes upfront. Often cheaper than your insurance excess with no premium increase.</p>
                        </div>
                        <div className="bg-white p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                    ...
                    <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
                            ...
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Panel Repair/Replacement</h3>
                            ...
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Quality Inspection</h3>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 md:px-8">
                    <div className="text-center mb-16">
                        ...
                        <div className="w-24 h-1.5 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full mb-6"></div>
                        <p className="text-xl text-gray-600">Everything you need to know about accident and collision repair in Rochdale</p>
                    </div>

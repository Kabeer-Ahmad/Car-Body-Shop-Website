...
export const metadata: Metadata = {
    ...
    description: `Professional full car respray in Rochdale. Expert colour matching & flawless finish. Fast turnaround. Call Car Body Shop: 07471512557.`,
    alternates: { canonical: 'https://carbodyshop.org/services/full-car-respray-rochdale' },
    openGraph: {
        title: `Full Car Respray Rochdale | Car Body Shop`,
        description: `Professional full car respray in Rochdale. Expert colour matching & flawless finish. Fast turnaround. Call Car Body Shop: 07471512557.`,
            ...
            <section className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white min-h-[50vh] sm:min-h-[55vh] md:min-h-[60vh] flex items-center justify-center overflow-hidden pt-20 pb-10 sm:pb-14 md:py-16">
                ...
                <div className="relative z-20 max-w-6xl mx-auto text-center px-4 sm:px-6 md:px-8 py-10 sm:py-14 md:py-16">
                    <div className="inline-block mb-4 sm:mb-6 px-6 py-2 bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 rounded-full">
                        <span className="text-blue-300 font-semibold text-sm tracking-wide">PROFESSIONAL CAR RESPRAY</span>
                    </div>
                    ...
                    <p className="text-base sm:text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed px-0">
                        Factory-quality finish with expert colour matching. Transform your vehicle's appearance.
                    </p>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    <div className="prose prose-lg md:prose-xl mx-auto text-gray-700 leading-relaxed space-y-6">
                        <p className="text-xl leading-relaxed">
                            If you are searching for a full car respray in Rochdale, Car Body Shop is the local specialist you can trust. Based in Whitworth, our professional body repair workshop delivers flawless paintwork for all makes and models — from everyday hatchbacks and family saloons through to prestige vehicles and commercial vans. Whether your car has suffered accident damage, heavy surface corrosion, or you simply want a brand-new colour, our team provides a factory-quality finish at a price that is fair and transparent.
                        </p>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 mb-3">Factory-Quality Finish</h3>
                            <p className="text-gray-600 leading-relaxed">Professional spray booth, computerised colour matching, and high-build lacquer protection.</p>
                        </div>
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                            ...
                            <p className="text-gray-600 leading-relaxed">Most full resprays completed within 2-5 working days with no compromise on quality.</p>
                        </div>
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 group hover:-translate-y-1">
                            ...
                            <p className="text-gray-600 leading-relaxed">Fair, itemised quotes upfront. Significantly cheaper than main dealer rates.</p>
                        </div>
                    </div>
                </div>
            </section>

            {/* Respray Process Section */}
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
                    <div className="mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-4 sm:mb-6">
                            Expert Car Respray & Bodywork Restoration
                        </h2>
                    ...
                    <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
                        <p>
                            Choosing the right body repair workshop for a full car respray is important. The difference between a budget job and a professional finish comes down to preparation, materials, and environment. At Car Body Shop, all paintwork is carried out inside our fully enclosed spray booth — a controlled environment that eliminates contamination from dust, insects, and moisture. As a result, you get a consistent, glass-smooth finish that simply cannot be replicated in an open workspace.
                        </p>

                        {/* Respray Process Steps */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Thorough cleaning, sanding, and masking for perfect paint adhesion</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Primer Application</h3>
                                    <p className="text-gray-600">Industry-grade primer for corrosion protection and smooth base</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Colour Matching</h3>
                                    <p className="text-gray-600">Computerised matching to your manufacturer paint code</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Basecoat Application</h3>
                                    <p className="text-gray-600">Multiple coats applied in professional spray booth</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Lacquer Protection</h3>
                                    <p className="text-gray-600">High-build lacquer for UV protection and deep shine</p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-2xl border border-blue-100">
                                ...
                                <div>
                                    <h3 className="font-bold text-xl text-gray-900 mb-2">Final Polishing</h3>
                                    <p className="text-gray-600">Professional detailing for showroom-quality finish</p>
                                </div>
                            </div>
                        </div>

                        <p>
                            Our technicians are experienced in working with all automotive paint systems, including water-based and solvent-based paints, metallic and pearl finishes, and specialist colours for prestige vehicles. Additionally, we use computerised colour-matching software to ensure the exact manufacturer shade is reproduced — even on older vehicles where the original paint has faded slightly. Every respray is finished with a high-build lacquer to provide long-term protection and a deep, showroom-quality shine.
                        </p>
                        
                        <p>
                            Car Body Shop has earned a strong reputation across Rochdale and Greater Manchester for honest pricing, fast turnaround, and consistently high-quality results. In fact, the majority of our new customers come through word-of-mouth recommendation from existing clients — which tells you everything you need to know about the standard of our work. Whether you are a private individual, a motor trader, or a fleet operator, we treat every vehicle with the same level of care and attention.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    <div className="text-center mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-4 sm:mb-6">
                            Why Choose Car Body Shop for Your Respray?
                        </h2>
                    ...
                    <div className="space-y-6 text-lg leading-relaxed text-gray-200">
                        <p>
                            Car Body Shop offers something that larger national chains simply cannot match — a personal, workshop-based service where your vehicle is looked after by the same experienced technician from start to finish. We have ten years of hands-on experience in automotive refinishing, and every job is backed by our commitment to quality. Therefore, when your vehicle leaves our workshop, it leaves looking exactly as it should.
                        </p>
                            ...
                            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-300">Trusted expertise in automotive refinishing</p>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/20">
                        ...
                        <p>
                            Fast turnaround is central to what we do. Most full car resprays are completed within two to five working days, and minor jobs can often be turned around even faster. Moreover, we offer a convenient collection and delivery service for customers across Rochdale, Oldham, Bury, Heywood, Middleton, Manchester, and Bolton — so you do not need to disrupt your schedule to benefit from our service.
                        </p>
                        
                        <p>
                            We are proud to be a premium but affordable alternative to main dealer bodyshops. Our pricing is honest, our estimates are itemised, and there are never any hidden charges. Likewise, we are happy to provide free advice on the most cost-effective approach for your specific repair before you commit to anything. Simply call us on 07471512557 or send photos of your vehicle via WhatsApp for a no-obligation quote within the hour.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Alongside our full car respray service, Car Body Shop offers a complete range of vehicle bodywork and paint solutions from our workshop in Rochdale.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Professional accident repair restoring your vehicle to its pre-accident condition — no insurance hassle required.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Priority bodyshop services for motor traders, dealers, and fleet operators across Greater Manchester.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Scuffs, cracks, and splits on all bumper types repaired and resprayed to a factory finish.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Traditional and paintless dent removal techniques for all sizes of dent, often without disturbing existing paintwork.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Deep or superficial scratch removal with precise colour matching and high-gloss lacquer for a seamless blend.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Scuffs, dents, and scratches repaired before your handover date to help you avoid costly end-of-lease penalty charges.</p>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    <div className="text-center mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        ...
                        <p className="text-xl text-blue-100 max-w-3xl mx-auto">
                            Providing professional full car respray services across Greater Manchester
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">Our workshop is based in Whitworth, making us ideally placed to serve the whole of the Rochdale borough. From the town centre through to Littleborough, Milnrow, and Heywood, we are your local car respray specialists.</p>
                            <Link href="/services/full-car-respray-rochdale" className="text-white font-semibold hover:text-blue-200 inline-flex items-center gap-2">
                                Book Your Respray
                                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                </svg>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">Oldham customers regularly travel to our Rochdale workshop for a full respray and bodywork restoration. Additionally, our collection service means you do not even need to make the journey yourself.</p></div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">We welcome customers from Bury looking for a professional car respray at a fair price. Furthermore, our collection and delivery service covers the Bury area at no extra charge.</p></div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">Heywood is just a short drive from our workshop, making us the natural first choice for car resprays in the area. Same-day quotes available for Heywood customers.</p></div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">Middleton customers are well within our service area. Motor traders in Middleton also benefit from our dedicated trade bodyshop service and priority booking slots.</p></div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">We serve customers from across Manchester and Greater Manchester. Our pricing is consistently lower than city-centre bodyshop rates — with no compromise on quality.</p></div>
                        ...
                        <div className="bg-white/10 backdrop-blur-md p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 md:hover:scale-105">
                            ...
                            <p className="text-blue-50 leading-relaxed mb-4">Bolton customers are welcome at Car Body Shop, and our collection and delivery service makes the process effortless. Call 07471512557 to arrange a booking from Bolton.</p></div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
                    <div className="text-center mb-8 sm:mb-8 sm:mb-10 md:mb-12 md:mb-16">
                        ...
                        <div className="w-24 h-1.5 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto rounded-full mb-4 sm:mb-6"></div>
                        <p className="text-xl text-gray-600">Everything you need to know about full car respray in Rochdale</p>
                    </div>
                    <div className="space-y-4">
                        <details className="group bg-gradient-to-br from-gray-50 to-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-md border border-gray-100 cursor-pointer transition-all hover:shadow-lg hover:border-blue-200">
                            ...
                            <div className="mt-6 text-gray-600 text-lg leading-relaxed border-t border-gray-200 pt-6">
                                <p>The cost of a full car respray in Rochdale depends on the size of the vehicle, the condition of the existing paintwork, and the preparation work required. As a general guide, prices typically start from around £800 for a standard-sized car. At Car Body Shop, we provide free, itemised quotes — send us photos on WhatsApp for an accurate price within the hour.</p>
                            </div>
                        </details>
                        ...
                        <details className="group bg-gradient-to-br from-gray-50 to-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-md border border-gray-100 cursor-pointer transition-all hover:shadow-lg hover:border-blue-200">
                            ...
                            <div className="mt-6 text-gray-600 text-lg leading-relaxed border-t border-gray-200 pt-6">
                                <p>Most full car resprays at Car Body Shop are completed within two to five working days. The exact timescale depends on the amount of surface preparation needed and the number of panels being resprayed. We always provide a realistic timeframe upfront and keep you updated throughout the process.</p>
                            </div>
                        </details>
                        ...
                        <details className="group bg-gradient-to-br from-gray-50 to-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-md border border-gray-100 cursor-pointer transition-all hover:shadow-lg hover:border-blue-200">
                            ...
                            <div className="mt-6 text-gray-600 text-lg leading-relaxed border-t border-gray-200 pt-6">
                                <p>Yes. We use computerised colour-matching technology and your vehicle's manufacturer paint code to mix the precise factory shade. Even on older vehicles where the original colour has faded, our technicians blend and feather the paint edges to ensure a consistent, seamless finish across all panels.</p>
                            </div>
                        </details>
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-br from-gray-50 to-blue-50/30 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    <div className="bg-gradient-to-br from-white to-blue-50/50 rounded-[3rem] p-6 sm:p-8 md:p-12 lg:p-16 text-center border border-gray-200 shadow-2xl backdrop-blur-sm">
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-4 sm:mb-6">
                            Get Your Free Quote for a Full Car Respray
                        </h2>
                        
                        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                            Ready to restore your vehicle's finish? Call or WhatsApp Car Body Shop today for a fast, free, no-obligation quote. We are based in Whitworth, Rochdale, and serve customers across Greater Manchester.
                        </p>

            ...
            <section className="py-12 sm:py-16 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="rounded-2xl overflow-hidden shadow-lg">
                        <Image
                            src="/blog-images/service-image2.webp"
                            alt="Car scratch repair — colour-matched finish"
                            width={800}
                            height={500}
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Complete vehicle resprays for cars requiring full paint restoration — ideal where scratches are part of a more extensive paint deterioration.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Priority scratch repair and paint correction for motor traders, dealerships, and fleet operators across Greater Manchester.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Comprehensive accident repair covering deep paint scratches and bodywork damage caused by collisions — restored to pre-accident condition.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Bumper scratches, scuffs, and paint chips repaired and colour-matched — one of the most frequent scratch repair requests we receive.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Panel dents repaired alongside scratch damage for a comprehensive single-visit bodywork restoration result.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Scratches and paint damage repaired before your lease vehicle handover to avoid costly end-of-contract penalty charges.</p>

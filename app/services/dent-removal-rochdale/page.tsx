            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8 my-12">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 md:gap-8">
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Professional accident damage repair including dent removal, panel beating, and full resprays for collision-damaged vehicles.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Complete resprays for vehicles requiring full colour restoration or a cosmetic transformation.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Bumper cracks, scuffs, and splits repaired and resprayed — often the cause of minor dents and panel damage.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Deep paint scratches and scuffs repaired with precision colour matching and high-gloss lacquer.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Priority dent removal and bodywork services for motor traders, dealerships, and fleet operators.</p>
                        ...
                        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                            ...
                            <p className="text-gray-600 mb-4 sm:mb-6 leading-relaxed">Dent removal before your lease vehicle handover date to help you avoid costly end-of-contract penalty charges.</p>

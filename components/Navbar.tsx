    ...
    const navLinks = [
        {
            ...
            href: '#',
            dropdown: [
                { name: 'Full Car Respray Rochdale', href: '/blog/full-car-respray-rochdale' },
                { name: 'Trade & Motor Dealer Bodyshop Services', href: '/blog/trade-motor-dealer-bodyshop-services' },
                { name: 'Accident & Collision Repair Rochdale', href: '/blog/accident-collision-repair-rochdale' },
                { name: 'Bumper Repair Rochdale', href: '/blog/bumper-repair-rochdale' },
                { name: 'Dent Removal Rochdale', href: '/blog/dent-removal-rochdale' },
                { name: 'Car Scratch Repair Rochdale', href: '/blog/car-scratch-repair-rochdale' },
                { name: 'Minor Accident Repair Rochdale', href: '/blog/minor-accident-repair-rochdale' },
                { name: 'Lease Return Repairs Rochdale', href: '/blog/lease-return-repairs-rochdale' },
            ]
        },
